 ...
 * @param {string} props.userCountryCode
 * @param {string | null} props.statusOpenKey
 * @param {(key: string | null) => void} props.onSetStatusOpenKey
 * @param {(movie: object, status: string) => void} props.onStatusChange
 * @param {(movie: object) => void} props.onOpenModal
 * @param {(movie: object) => void} props.onRequestRemove
 */
