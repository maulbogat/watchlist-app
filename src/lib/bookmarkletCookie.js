 ...
 * @param {{ uid: string, getIdToken: () => Promise<string> } | null} user
 * @param {unknown} currentListMode — same shapes as Zustand store
 */
export async function setBookmarkletCookieWithMode(user, currentListMode) {
